...
exports.getAchievementById = exports.ACHIEVEMENTS = void 0;
...
exports.ACHIEVEMENTS = [
    {
        ...
        verifier: function (user) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, count, error;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error || !data)
                            return [2 /*return*/, false];
                        return [2 /*return*/, data.streak >= 7];
                }
            });
        }); },
    },
];
var getAchievementById = function (id) {
    return exports.ACHIEVEMENTS.find(function (a) { return a.id === id; });
};
