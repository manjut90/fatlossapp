...
var AchievementService = /** @class */ (function () {
     ...
     */
    AchievementService.prototype.getUserAchievements = function (userId) {
     ...
     */
    AchievementService.prototype.unlockAchievement = function (userId, achievementId, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.hasAchievement(userId, achievementId)];
                    case 2:
                        existing = _b.sent();
                        if (existing)
     ...
     */
    AchievementService.prototype.hasAchievement = function (userId, achievementId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
