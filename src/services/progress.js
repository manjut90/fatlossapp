...
exports.addXp = addXp;
exports.updateLastCelebratedLevel = updateLastCelebratedLevel;
var supabase_1 = require("../services/supabase");
var level_1 = require("./level");
function addXp(amount) {
    return __awaiter(this, void 0, void 0, function () {
        var existing, newXp, level, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    newXp = (existing.xp || 0) +
                        amount;
                    level = (0, level_1.getLevel)(newXp);
                    return [4 /*yield*/, supabase_1.supabase
                            .from('user_progress')
                            .update({
                            xp: newXp,
...
function updateLastCelebratedLevel(level, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var resolvedUserId, _a, error, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                ...
                case 4:
                    err_2 = _b.sent();
                    console.error('Error updating last celebrated level:', err_2);
